...
public class TransactionTypeFilterRecyclerViewAdapter extends RecyclerView.Adapter<TransactionTypeFilterRecyclerViewAdapter.ViewHolder> {
    ...
    public TransactionTypeFilterRecyclerViewAdapter(Context ctx, FilterDetails filterDetails, int[] itemPositionStatus, OnNoteListener onNoteListener){
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull TransactionTypeFilterRecyclerViewAdapter.ViewHolder holder, int position) {
        holder.attributeTextView.setText(filterDetails.getTransactionTypeDetails().get(position).getTransactionTypeName());
    ...
    public int getItemCount() {
        return filterDetails.getTransactionTypeDetails().size();
    }
